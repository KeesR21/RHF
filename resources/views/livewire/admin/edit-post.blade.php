            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <form enctype="multipart/form-data">
                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <button wire:click.prevent="savePost" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Edit Post
                                </button>
                            </div>
                            @else
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <button wire:click.prevent="savePost" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Save Post
                                </button>
                            </div>
                            @endif
                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Add New</h3>
...
<script>
    ClassicEditor
        .create(document.querySelector('#post_boy'))
        .catch(error => {
            console.error(error);
        });
</script>