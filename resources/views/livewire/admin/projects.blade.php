<div class="pt-6">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input rows="3" wire:model="title" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" type="text" placeholder="Project Title">
                            ...
                            <div wire:ignore>
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Provide the detailed content for the project - This field' height adjusts automatically
                                </p>
                            </div>
                            <div class="mt-6">
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <button id="submit" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Save Project
                            </button>
                        </div>
                        @else
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <button id="submit" wire:click="editProject" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Edit Project
                            </button>
                        </div>
                        @endif
            ...
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Add New Project</h3>
    ...
    <div class="hidden sm:block mb-6 pt-6" aria-hidden="true">
        <div class="py-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                                        <img src="{{ asset('images/uploads/'.$project->image) }}" class="h-12 w-12 bg-white rounded-full border" alt="..." />
                                    ...
                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        {{ str_limit($project->description, 160) }}
                                    </td>
                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        <button id="submit" wire:click="loadProjectInfoToForm({{ $project }})" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                                            View
                                        </button>
                                        <button wire:click="deleteProject({{ $project }})" class="bg-red-600 hover:bg-red-900 text-gray-50 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                                            Delete
                                        </button>
                                    </td>
